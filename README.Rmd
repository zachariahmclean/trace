...
This code is not for clinical use or accurate repeat genotyping. There are features for accurate repeat sizing if you use validated control samples, but whole repeat units are never returned.
