...
If you use this package, please cite [this](https://doi.org/10.1038/s41467-024-47485-0) paper for now.
...
These metrics can then be used to quantify repeat instability. For example, this reproduces Figure 7e of [our manuscript](https://doi.org/10.1038/s41467-024-47485-0).
