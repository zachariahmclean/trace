...
For an easy way to get started with your own data or to run an example, use `trace::generate_instability_template()` to generate a document with the pipeline pre-populated.
